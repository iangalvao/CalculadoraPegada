...
export default function SelectState() {
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-[#5163b8] text-white p-4">
      {/* Header */}
      <div className="flex justify-between items-center border-2 border-[rgb(80,255,40)] p-4">
      ...
      {/* Grid of states */}
      <div className="grid grid-cols-4 grid-rows-7 gap-px flex-grow border-2 border-[rgb(80,255,40)] m-2">
        {states.map((state, index) => (
          <div
            ...
            className={`border border-[rgb(80,255,40)] flex items-center justify-center text-2xl font-medium cursor-pointer 
              ${selectedState === state ? 'bg-[rgb(80,255,40)] font-bold' : 'hover:bg-[rgb(80,255,40)]'}`}
          >
            {state}
          </div>
        ))}
